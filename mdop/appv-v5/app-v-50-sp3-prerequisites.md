...
|--|--|
| Supported version of SQL Server | For supported versions, see [App-V 5.0 SP3 Supported Configurations](app-v-50-sp3-supported-configurations.md). |
...
| Microsoft Silverlight 5 | The Management console is available only if Silverlight is installed. |

### Management server database prerequisite software

The Management database is required only if you're using the App-V 5.0 SP3 Management server.
...
The Reporting database is required only if you're using the App-V 5.0 SP3 Reporting server.
