...
1.  Open your preferred management tool:
    ...
    -   **Group Policy** - If you have not already done so, download the ADMX template for UE-V 2 from  [How to Download and Deploy MDOP Group Policy (.admx) Templates](https://learn.microsoft.com/microsoft-desktop-optimization-pack/solutions/how-to-download-and-deploy-mdop-group-policy--admx--templates).
