...
>
> Also note that stand-alone MBAM integration with Configuration Manager was only supported through Configuration Manager Current Branch version 1902. Since Configuration Manager Current Branch version 1902 is out of support, using the `Invoke-MbamClientDeployment.ps1` PowerShell script with stand-alone MBAM and currently supported versions of Configuration Manager is no longer supported. For more information, see [Versions of Configuration Manager that MBAM supports](mbam-25-supported-configurations.md#versions-of-configuration-manager-that-mbam-supports).
