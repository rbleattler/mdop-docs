...
>
> Starting with Configuration Manager, version 2203 BitLocker Management, escrowing of the BitLocker key during a task sequence is available natively in the Configuration Manager task sequence **Enable BitLocker** task via the option **Automatically store the recovery key in:** > **The Configuration Manager database**.
>
