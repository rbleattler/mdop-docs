...
Customers not using Config Manager can utilize the built-in features of Azure AD and Microsoft Endpoint Manager Microsoft Intune (MEMMI) for administration and monitoring, see [Manage BitLocker policy for Windows devices with Intune](/mem/intune/protect/encrypt-devices)
