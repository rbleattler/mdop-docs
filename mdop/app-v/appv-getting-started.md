...
Starting with Windows 10 version 1607, App-V is included with the [Windows 10 for Enterprise edition](https://www.microsoft.com/windows/business). If you're new to Windows client and App-V, you'll need to download, activate, and install server- and client-side components to start delivering virtual applications to users. To learn what you need to know before getting started with App-V, see the [Application Virtualization (App-V) overview](appv-for-windows.md).
...
To learn more about previous versions of App-V, see [MDOP information experience](../index.md).
